...
public class MovieController {
    ...
    public ResponseEntity<MovieDTO> updateMovieHandler(@PathVariable Long movieId, @RequestPart MultipartFile file, @RequestPart String movieDtoObj) throws IOException{
        if (file.isEmpty()) {
            file = null;
        }
